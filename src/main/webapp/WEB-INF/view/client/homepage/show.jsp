                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-8 text-end">
                                <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                    <li class="nav-item">
                                        <a class="d-flex m-2 p-2 bg-light rounded-pill active" data-bs-toggle="pill"
                                            href="#tab-1">
                                            <span class="text-dark">Tất cả sản phẩm</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row g-4">
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item border border-2">
                                                    <div class="fruite-img p-3">
                                                        <img src="/client/img/fruite-item-1.jpg"
                                                            class="img-fluid w-100 rounded-top" alt="">
                                                    </div>
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                        style="top: 10px; left: 10px;">Điện thoại</div>
                                                    <div class="p-4 rounded-bottom">
                                                        <h6>Iphone 16 Promax</h6>
                                                        <p>...</p>
