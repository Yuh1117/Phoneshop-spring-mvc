                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    ...
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Điện thoại</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="/client/img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded"
                                        alt="Second slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Chơi game</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="/client/img/hero-img-3.jpg" class="img-fluid w-100 h-100 rounded"
                                        alt="Second slide">
